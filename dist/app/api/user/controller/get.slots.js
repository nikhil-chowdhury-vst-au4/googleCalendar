...
class GetUserSlots extends MasterController {
    static doc() {
        return {
            tags: ['User'],
    ...
    controller() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield user_service_1.default.getUserSlots(this.data.userId, this.data.serviceId, this.data.lastDate);
...
exports.default = GetUserSlots;
//# sourceMappingURL=get.slots.js.map