...
class GetUserModifiedDates extends MasterController {
    static doc() {
        return {
            tags: ['User'],
    ...
    controller() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield user_service_1.default.getUserModifiedDates(this.req.user);
...
exports.default = GetUserModifiedDates;
//# sourceMappingURL=get.availability.modifications.js.map