...
class SendCreateOrUpdateProfile extends MasterController {
    static doc() {
        return {
            tags: ['User'],
    ...
    controller() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield user_service_1.default.sendCreatorMarketingMessages(this.data.limit, this.data.offset);
            }
            catch (error) {
...
exports.default = SendCreateOrUpdateProfile;
//# sourceMappingURL=send.creatorMarketing.js.map