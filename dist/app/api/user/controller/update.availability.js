...
class EditUserAvailability extends MasterController {
    static doc() {
        return {
            tags: ['User'],
    ...
    controller() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield user_service_1.default.editAvailibilityOfUser(this.data.availability, this.req.user);
...
exports.default = EditUserAvailability;
//# sourceMappingURL=update.availability.js.map