...
exports.sequelize = new sequelize_typescript_1.Sequelize(process.env.SEQUELIZE_WRITE_DB_NAME, process.env.SEQUELIZE_WRITE_DB_USER, process.env.SEQUELIZE_WRITE_DB_PASSWORD, Object.assign({}, options));
